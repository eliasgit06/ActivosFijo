...
namespace ActivosFijo.Controllers
{
    ...
    public class PlanesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Plan,Descripcion,RegistradoPor,FechaRegistro")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Plan,Descripcion,RegistradoPor,FechaRegistro")] Plane plane)
        {
            if (ModelState.IsValid)
            {
